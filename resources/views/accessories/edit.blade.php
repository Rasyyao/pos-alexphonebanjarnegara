            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div class="bg-white rounded-xl border overflow-hidden" style="border-color:var(--line)">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div x-data="{
                            method: '{{ old('purchase_cash', $accessory->purchase_cash) > 0 && old('purchase_transfer', $accessory->purchase_transfer) > 0 ? 'split' : old('purchase_payment_method', $accessory->purchase_payment_method ?? 'cash') }}',
                            isSyncing: false,
                            qty: {{ old('stock_qty', $accessory->stock_qty) }},
                            init() {
                                this.$nextTick(() => {
